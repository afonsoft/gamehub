...
import { DeveloperShellComponent } from './components/developer-shell/developer-shell.component';

export const developerRoutes: Routes = [
  {
    path: '',
    component: DeveloperShellComponent,
    children: [
      {
        path: '',
        loadComponent: () => import('./dashboard/dashboard.component').then(m => m.DeveloperDashboardComponent),
        pathMatch: 'full',
      },
      {
        path: 'games',
