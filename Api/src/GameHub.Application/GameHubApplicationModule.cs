...
namespace GameHub
{
    ...
    public class GameHubApplicationModule : AbpModule
    {
        public override void PreInitialize()
        {
            //Adding custom AutoMapper configuration
            Configuration.Modules.AbpAutoMapper().Configurators.Add(GameHubCustomDtoMapper.CreateMappings);
        ...
        {
            IocManager.RegisterAssemblyByConvention(typeof(GameHubApplicationModule).GetAssembly());
        }
        ...
        public override void PostInitialize()
        {
            ...
            using (var _connectionStringResolver = IocManager.ResolveAsDisposable<DefaultConnectionStringResolver>())
            {
                ...
                {
                    using (var _migrator = IocManager.ResolveAsDisposable<GameHubDbMigrator>())
                    {
