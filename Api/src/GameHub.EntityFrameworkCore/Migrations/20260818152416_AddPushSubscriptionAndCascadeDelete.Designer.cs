...
namespace GameHub.Migrations
{
    ...
    [Migration("20260818152416_AddPushSubscriptionAndCascadeDelete")]
    partial class AddPushSubscriptionAndCascadeDelete
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Eaf.Middleware.MultiTenancy.TenantJoinRequest", b =>
                {
                    ...
                    b.ToTable("AbpTenantJoinRequests");
                });
            ...
            modelBuilder.Entity("Eaf.Middleware.MultiTenancy.UserTenantMembership", b =>
                {
                    ...
                    b.ToTable("gh_UserTenantMemberships", (string)null);
                });
            ...
            modelBuilder.Entity("Eaf.Middleware.Payments.SubscriptionPaymentProduct", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
                    ...
                    b.HasIndex("TenantId", "SubscriptionPaymentId");

                    b.ToTable("EafSubscriptionPaymentProducts");
                });
            ...
            modelBuilder.Entity("Eaf.Notifications.Push.PushSubscription", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
                    ...
                    b.ToTable("EafPushSubscriptions");
                });

            modelBuilder.Entity("GameHub.ArbitraryUserData.ArbitraryUserDataRecord", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("GameId", "AnonymousIdHash", "Key");

                    b.HasIndex("GameId", "UserId", "AnonymousIdHash", "Key");

                    b.ToTable("gh_ArbitraryUserData", (string)null);
                });
            ...
            modelBuilder.Entity("GameHub.Catalog.Game", b =>
                {
                    ...
                    b.Property<int>("MaxPlayersPerMatch")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                        .HasDefaultValue(0);
            ...
            modelBuilder.Entity("GameHub.Multiplayer.MatchHistory", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("gh_MatchHistories", (string)null);
                });

            modelBuilder.Entity("GameHub.Multiplayer.MatchParticipant", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("MatchId", "IsActive");

                    b.ToTable("gh_MatchParticipants", (string)null);
                });

            modelBuilder.Entity("GameHub.Multiplayer.MatchState", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.Property<Guid?>("RankedSeasonId")
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("gh_MatchStates", (string)null);
                });

            modelBuilder.Entity("GameHub.Multiplayer.MultiplayerSecurityEvent", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("gh_MultiplayerSecurityEvents", (string)null);
                });

            modelBuilder.Entity("GameHub.Multiplayer.PlayerRating", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("GameId", "SeasonId", "Mode", "UserId")
                        .IsUnique();

                    b.ToTable("gh_PlayerRatings", (string)null);
                });

            modelBuilder.Entity("GameHub.Multiplayer.RankedQueueEntry", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("GameId", "SeasonId", "Mode", "Region", "Status", "EnqueuedAt");

                    b.ToTable("gh_RankedQueueEntries", (string)null);
                });

            modelBuilder.Entity("GameHub.Multiplayer.RankedSeason", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("GameId", "Mode", "IsActive");

                    b.ToTable("gh_RankedSeasons", (string)null);
                });

            modelBuilder.Entity("GameHub.Multiplayer.ReplayMetadata", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("gh_ReplayMetadata", (string)null);
                });
            ...
            modelBuilder.Entity("GameHub.Social.GameInvite", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("GameHub.Social.GameNotification", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Eaf.Middleware.Payments.SubscriptionPaymentProduct", b =>
                {
                    b.HasOne("Eaf.Middleware.Payments.SubscriptionPayment", "SubscriptionPayment")
                        .WithMany("Products")
            ...
            modelBuilder.Entity("GameHub.Multiplayer.MatchParticipant", b =>
                {
                    b.HasOne("GameHub.Multiplayer.MatchState", "Match")
            ...
            modelBuilder.Entity("GameHub.Multiplayer.ReplayMetadata", b =>
                {
                    b.HasOne("GameHub.Multiplayer.MatchHistory", null)
                        .WithOne("Replay")
                        .HasForeignKey("GameHub.Multiplayer.ReplayMetadata", "MatchHistoryId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
