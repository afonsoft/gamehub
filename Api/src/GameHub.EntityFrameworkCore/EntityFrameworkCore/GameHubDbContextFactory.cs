...
namespace GameHub.EntityFrameworkCore
{
    ...
    public class GameHubDbContextFactory : IDesignTimeDbContextFactory<GameHubDbContext>
    {
        ...
        public GameHubDbContext CreateDbContext(string[] args)
        {
            ...
            return new GameHubDbContext(builder.Options);
        }
        ...
        {
            var coreAssemblyDirectoryPath = Path.GetDirectoryName(typeof(GameHubDbContextFactory).Assembly.Location);
