...
{
    public class ProjectNameNotifier_SendMessage_Tests : ProjectNameTestBase
    {
        private readonly IProjectNameNotifier _notifier;

        public ProjectNameNotifier_SendMessage_Tests()
        {
            _notifier = LocalIocManager.Resolve<IProjectNameNotifier>();
        }
