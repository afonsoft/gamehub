...
Copy the `Eaf.ProjectName.UI` folder to your desired location.
...
http-server dist/Eaf.ProjectName.UI
```
...
server {
    ...
    root /path/to/dist/Eaf.ProjectName.UI;
    index index.html;
