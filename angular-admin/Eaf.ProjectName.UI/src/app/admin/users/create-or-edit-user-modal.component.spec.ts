...
import { UserServiceProxy, ProfileServiceProxy } from '@shared/service-proxies/service-proxies';
...
import {
  ...
  MockUserServiceProxy, MockProfileServiceProxy, setupEafGlobals,
  MockLocalizePipe,
...
describe('CreateOrEditUserModalComponent', () => {
  ...
  beforeEach(() => {
    ...
    TestBed.configureTestingModule({
      declarations: [CreateOrEditUserModalComponent, MockLocalizePipe],
