...
import {
  ...
  MockUserServiceProxy, setupEafGlobals,
  MockLocalizePipe,
} from '../../../test-helpers/mock-services';

describe('EditUserPermissionsModalComponent', () => {
  let component: EditUserPermissionsModalComponent;
  let fixture: ComponentFixture<EditUserPermissionsModalComponent>;

  beforeEach(() => {
    setupEafGlobals();
    TestBed.configureTestingModule({
      declarations: [EditUserPermissionsModalComponent, MockLocalizePipe],
    ...
    fixture = TestBed.createComponent(EditUserPermissionsModalComponent);
  ...
  it('should have resettingPermissions set to false initially', () => {
    expect(component.resettingPermissions).toBeFalsy();
  });
});
