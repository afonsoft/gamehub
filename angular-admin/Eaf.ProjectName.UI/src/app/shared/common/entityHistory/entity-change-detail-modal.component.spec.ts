...
import {
  ...
  MockAuditLogServiceProxy, setupEafGlobals,
  MockLocalizePipe,
} from '../../../../test-helpers/mock-services';

describe('EntityChangeDetailModalComponent', () => {
  let component: EntityChangeDetailModalComponent;
  let fixture: ComponentFixture<EntityChangeDetailModalComponent>;
  ...
  beforeEach(() => {
    ...
    fixture = TestBed.createComponent(EntityChangeDetailModalComponent);
