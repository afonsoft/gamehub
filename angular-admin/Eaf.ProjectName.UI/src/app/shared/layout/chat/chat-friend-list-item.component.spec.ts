...
describe('ChatFriendListItemComponent', () => {
  let component: ChatFriendListItemComponent;
  let fixture: ComponentFixture<ChatFriendListItemComponent>;

  beforeEach(() => {
    setupEafGlobals();
    TestBed.configureTestingModule({
      declarations: [ChatFriendListItemComponent, MockLocalizePipe],
      providers: [
    ...
    fixture = TestBed.createComponent(ChatFriendListItemComponent);
