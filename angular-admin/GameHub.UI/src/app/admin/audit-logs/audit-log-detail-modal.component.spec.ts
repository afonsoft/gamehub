...
describe('AuditLogDetailModalComponent', () => {
  let component: AuditLogDetailModalComponent;
  let fixture: ComponentFixture<AuditLogDetailModalComponent>;
  ...
  beforeEach(() => {
    ...
    fixture = TestBed.createComponent(AuditLogDetailModalComponent);
  ...
  it('should have auditLog undefined initially', () => {
    expect(component.auditLog).toBeUndefined();
  });
});
