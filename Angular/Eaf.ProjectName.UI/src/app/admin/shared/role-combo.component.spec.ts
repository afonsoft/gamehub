...
describe('RoleComboComponent', () => {
  let component: RoleComboComponent;
  let fixture: ComponentFixture<RoleComboComponent>;

  beforeEach(() => {
    setupEafGlobals();
    TestBed.configureTestingModule({
      declarations: [RoleComboComponent, MockLocalizePipe],
      providers: [
    ...
    fixture = TestBed.createComponent(RoleComboComponent);
  ...
  it('should have roles array initialized', () => {
