...
import {
  ...
  MockTenantServiceProxy, setupEafGlobals,
  MockLocalizePipe,
} from '../../../test-helpers/mock-services';

describe('TenantFeaturesModalComponent', () => {
  let component: TenantFeaturesModalComponent;
  let fixture: ComponentFixture<TenantFeaturesModalComponent>;

  beforeEach(() => {
    setupEafGlobals();
    TestBed.configureTestingModule({
      declarations: [TenantFeaturesModalComponent, MockLocalizePipe],
    ...
    fixture = TestBed.createComponent(TenantFeaturesModalComponent);
  ...
  it('should have resettingFeatures set to false initially', () => {
    expect(component.resettingFeatures).toBeFalsy();
  });
});
