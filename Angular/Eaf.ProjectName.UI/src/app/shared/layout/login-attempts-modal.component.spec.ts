...
import { UserLoginServiceProxy } from '@shared/service-proxies/service-proxies';
...
import {
  ...
  MockDateTimeService, MockProfileServiceProxy,
  setupEafGlobals,
  MockLocalizePipe,
} from '../../../test-helpers/mock-services';
import { of } from 'rxjs';

class MockUserLoginServiceProxy {
  getRecentUserLoginAttempts(): any {
    return of({ items: [] });
  }
}

describe('LoginAttemptsModalComponent', () => {
  let component: LoginAttemptsModalComponent;
  let fixture: ComponentFixture<LoginAttemptsModalComponent>;

  beforeEach(() => {
    setupEafGlobals();
    TestBed.configureTestingModule({
      declarations: [LoginAttemptsModalComponent, MockLocalizePipe],
      imports: [ModalModule.forRoot()],
      providers: [
        { provide: ProfileServiceProxy, useClass: MockProfileServiceProxy },
        { provide: UserLoginServiceProxy, useClass: MockUserLoginServiceProxy },
    ...
    fixture = TestBed.createComponent(LoginAttemptsModalComponent);
