...
describe('DefaultBrandComponent', () => {
  let component: DefaultBrandComponent;
  let fixture: ComponentFixture<DefaultBrandComponent>;

  beforeEach(() => {
    setupEafGlobals();
    TestBed.configureTestingModule({
      declarations: [DefaultBrandComponent, MockLocalizePipe],
      providers: [
    ...
    fixture = TestBed.createComponent(DefaultBrandComponent);
