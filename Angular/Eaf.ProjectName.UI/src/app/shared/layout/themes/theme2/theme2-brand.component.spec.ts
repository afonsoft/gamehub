...
describe('Theme2BrandComponent', () => {
  let component: Theme2BrandComponent;
  let fixture: ComponentFixture<Theme2BrandComponent>;

  beforeEach(() => {
    setupEafGlobals();
    TestBed.configureTestingModule({
      declarations: [Theme2BrandComponent, MockLocalizePipe],
      providers: [
    ...
    fixture = TestBed.createComponent(Theme2BrandComponent);
