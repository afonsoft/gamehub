...
describe('Theme3BrandComponent', () => {
  let component: Theme3BrandComponent;
  let fixture: ComponentFixture<Theme3BrandComponent>;

  beforeEach(() => {
    setupEafGlobals();
    TestBed.configureTestingModule({
      declarations: [Theme3BrandComponent, MockLocalizePipe],
      providers: [
    ...
    fixture = TestBed.createComponent(Theme3BrandComponent);
