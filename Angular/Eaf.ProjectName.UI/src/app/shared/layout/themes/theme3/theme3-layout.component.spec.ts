...
import { Theme3LayoutComponent } from './theme3-layout.component';
...
describe('Theme3LayoutComponent', () => {
  let component: Theme3LayoutComponent;
  let fixture: ComponentFixture<Theme3LayoutComponent>;

  beforeEach(() => {
    setupEafGlobals();
    TestBed.configureTestingModule({
      declarations: [Theme3LayoutComponent, MockLocalizePipe],
      providers: [
    ...
    fixture = TestBed.createComponent(Theme3LayoutComponent);
