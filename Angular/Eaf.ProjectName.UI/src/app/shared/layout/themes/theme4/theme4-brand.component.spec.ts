...
describe('Theme4BrandComponent', () => {
  let component: Theme4BrandComponent;
  let fixture: ComponentFixture<Theme4BrandComponent>;

  beforeEach(() => {
    setupEafGlobals();
    TestBed.configureTestingModule({
      declarations: [Theme4BrandComponent, MockLocalizePipe],
      providers: [
    ...
    fixture = TestBed.createComponent(Theme4BrandComponent);
