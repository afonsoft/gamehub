...
class MockAppNavigationService {
  getMenu(): any[] { return []; }
  checkChildMenuItemPermission(menuItem: any): boolean { return true; }
  showMenuItem(menuItem: any): boolean { return true; }
}
...
describe('TopBarMenuComponent', () => {
  ...
  beforeEach(() => {
    ...
    TestBed.configureTestingModule({
      declarations: [TopBarMenuComponent, MockLocalizePipe],
      providers: [
