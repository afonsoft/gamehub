...
[Edit on GitHub](https://github.com/aspnetboilerplate/aspnetboilerplate/blob/master/doc/WebSite/Logging.md)

In this document

### Server Side [Anchor](https://aspnetboilerplate.com/Pages/Documents/Logging\#server-side)
...
[templates](https://aspnetboilerplate.com/Templates) come with Log4Net properly configured and ready to use.
There is just a single-line of code for the dependency to log4net (as
seen in the [configuration](https://aspnetboilerplate.com/Pages/Documents/Logging#configuration) section), so you can easily change it to
your favourite library.

#### Getting The Logger [Anchor](https://aspnetboilerplate.com/Pages/Documents/Logging\#getting-the-logger)
...
injection](https://aspnetboilerplate.com/Pages/Documents/Dependency-Injection), we can easily inject
a **Logger** object using the [property\\
injection](https://aspnetboilerplate.com/Pages/Documents/Dependency-Injection#property-injection-pattern)
...
There are different levels (see the [configuration](https://aspnetboilerplate.com/Pages/Documents/Logging#config) section).
...
#### Base Classes With Logger [Anchor](https://aspnetboilerplate.com/Pages/Documents/Logging\#base-classes-with-logger)

ASP.NET Boilerplate provides **base classes** for MVC controllers, Web
API controllers, [Application\\
service](https://aspnetboilerplate.com/Pages/Documents/Application-Services) classes and more. They
...
#### Configuration [Anchor](https://aspnetboilerplate.com/Pages/Documents/Logging\#configuration)

All the configuration is done for Log4Net when you create your application
from the ASP.NET Boilerplate [templates](https://aspnetboilerplate.com/Templates).
...
#### Abp.Castle.Log4Net Package [Anchor](https://aspnetboilerplate.com/Pages/Documents/Logging\#abp-castle-log4net-package)
...
### Client-Side [Anchor](https://aspnetboilerplate.com/Pages/Documents/Logging\#client-side)
...
documentation](https://aspnetboilerplate.com/Pages/Documents/Javascript-API/Logging).
