...
[Edit on GitHub](https://github.com/aspnetboilerplate/aspnetboilerplate/blob/master/doc/WebSite/Notification-System.md)

In this document

### Introduction [Anchor](https://aspnetboilerplate.com/Pages/Documents/Notification-System\#introduction)
...
#### Sending Models [Anchor](https://aspnetboilerplate.com/Pages/Documents/Notification-System\#sending-models)
...
#### Notification Types [Anchor](https://aspnetboilerplate.com/Pages/Documents/Notification-System\#notification-types)
...
#### Notification Data [Anchor](https://aspnetboilerplate.com/Pages/Documents/Notification-System\#notification-data)
...
have two data properties: _sender user name_ (which user sent this
friendship request) and a _request note_ (a note that the user wrote in
...
#### Notification Severity [Anchor](https://aspnetboilerplate.com/Pages/Documents/Notification-System\#notification-severity)
...
#### About Notification Persistence [Anchor](https://aspnetboilerplate.com/Pages/Documents/Notification-System\#about-notification-persistence)

See the _Notification Store_ section for more information on notification
persistence.

### Subscribe to Notifications [Anchor](https://aspnetboilerplate.com/Pages/Documents/Notification-System\#subscribe-to-notifications)
...
First, we [injected](https://aspnetboilerplate.com/Pages/Documents/Dependency-Injection) the
...
_SentFriendshipRequest_ and _CommentPhoto_ in the examples)
...
### Publish Notifications [Anchor](https://aspnetboilerplate.com/Pages/Documents/Notification-System\#publish-notifications)
...
_SentFriendshipRequestNotificationData_ should be derived from
...
[localization](https://aspnetboilerplate.com/Pages/Documents/Localization). The localization message can
include these arguments (like " _Attention! Only {remainingDiskInMb} MBs_
_left on the disk!_" as an example). We will see how to localize it on
the client-side section.

### User Notification Manager [Anchor](https://aspnetboilerplate.com/Pages/Documents/Notification-System\#user-notification-manager)
...
### Real-Time Notifications [Anchor](https://aspnetboilerplate.com/Pages/Documents/Notification-System\#real-time-notifications)
...
separated package. The [startup templates](https://aspnetboilerplate.com/Templates) already have SignalR
installed. See the [SignalR Integration\\
document](https://aspnetboilerplate.com/Pages/Documents/SignalR-Integration) for more information.

**Note**: The notification system calls **IRealTimeNotifier** asynchronously
in a [**background job**](https://aspnetboilerplate.com/Pages/Documents/Background-Jobs-And-Workers).
Because of this, notifications may be sent with a small delay.

#### Multiple Notifiers [Anchor](https://aspnetboilerplate.com/Pages/Documents/Notification-System\#multiple-notifiers)
...
#### Client-Side [Anchor](https://aspnetboilerplate.com/Pages/Documents/Notification-System\#client-side)
...
bus](https://aspnetboilerplate.com/Pages/Documents/Javascript-API/Event-Bus) documentation for more
...
[abp.notify](https://aspnetboilerplate.com/Pages/Documents/Javascript-API/Notification) api instead to show
...
notification](https://aspnetboilerplate.com/Pages/Documents/Javascript-API/Notification) when a push
...
This shows a [UI\\
notification](https://aspnetboilerplate.com/Pages/Documents/Javascript-API/Notification) like this
(for System.LowDisk notification published above):

![](https://raw.githubusercontent.com/aspnetboilerplate/aspnetboilerplate/master/doc/WebSite/images/notification-warn.png)
...
The [startup templates](https://aspnetboilerplate.com/Templates) include the code to show UI
notifications when a push notification is received.

### Notification Store [Anchor](https://aspnetboilerplate.com/Pages/Documents/Notification-System\#notification-store)
...
**[Module Zero](https://aspnetboilerplate.com/Pages/Documents/Zero/Overall)** which already
implements it.

### Notification Definitions [Anchor](https://aspnetboilerplate.com/Pages/Documents/Notification-System\#notification-definitions)
...
[permission](https://aspnetboilerplate.com/Pages/Documents/Authorization).
