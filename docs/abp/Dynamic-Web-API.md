...
[Edit on GitHub](https://github.com/aspnetboilerplate/aspnetboilerplate/blob/master/doc/WebSite/Dynamic-Web-API.md)

In this document

### Building Dynamic Web API Controllers [Anchor](https://aspnetboilerplate.com/Pages/Documents/Dynamic-Web-API\#building-dynamic-web-api-controllers)

This document is for the ASP.NET Web API. If you're interested in ASP.NET
Core, see the [ASP.NET Core](https://aspnetboilerplate.com/Pages/Documents/AspNet-Core) documentation.
...
service](https://aspnetboilerplate.com/Pages/Documents/Application-Services) as shown below:
...
of your [module](https://aspnetboilerplate.com/Pages/Documents/Module-System).
...
#### ForAll Method [Anchor](https://aspnetboilerplate.com/Pages/Documents/Dynamic-Web-API\#forall-method)
...
#### Overriding ForAll [Anchor](https://aspnetboilerplate.com/Pages/Documents/Dynamic-Web-API\#overriding-forall)
...
##### ForMethods [Anchor](https://aspnetboilerplate.com/Pages/Documents/Dynamic-Web-API\#formethods)
...
#### Http Verbs [Anchor](https://aspnetboilerplate.com/Pages/Documents/Dynamic-Web-API\#http-verbs)
...
##### WithVerb Method [Anchor](https://aspnetboilerplate.com/Pages/Documents/Dynamic-Web-API\#withverb-method)
...
##### HTTP Attributes [Anchor](https://aspnetboilerplate.com/Pages/Documents/Dynamic-Web-API\#http-attributes)
...
##### Naming Convention [Anchor](https://aspnetboilerplate.com/Pages/Documents/Dynamic-Web-API\#naming-convention)
...
#### API Explorer [Anchor](https://aspnetboilerplate.com/Pages/Documents/Dynamic-Web-API\#api-explorer)

All dynamic web api controllers are visible to the API explorer by default
(They are available in [Swagger](https://aspnetboilerplate.com/Pages/Documents/Swagger-UI-Integration), for
...
#### RemoteService Attribute [Anchor](https://aspnetboilerplate.com/Pages/Documents/Dynamic-Web-API\#remoteservice-attribute)
...
### Dynamic JavaScript Proxies [Anchor](https://aspnetboilerplate.com/Pages/Documents/Dynamic-Web-API\#dynamic-javascript-proxies)
...
[abp.ajax](https://aspnetboilerplate.com/Pages/Documents/Javascript-API/AJAX). They handle
errors and show error messages if needed.

#### AJAX Parameters [Anchor](https://aspnetboilerplate.com/Pages/Documents/Dynamic-Web-API\#ajax-parameters)
...
#### Single Service Script [Anchor](https://aspnetboilerplate.com/Pages/Documents/Dynamic-Web-API\#single-service-script)

'/api/AbpServiceProxies/GetAll' generates all service proxies in one
file. You can also generate a single service proxy using
'/api/AbpServiceProxies/Get?name= _serviceName_' and by including the script
...
#### AngularJS Integration [Anchor](https://aspnetboilerplate.com/Pages/Documents/Dynamic-Web-API\#angularjs-integration)
...
#### Minification [Anchor](https://aspnetboilerplate.com/Pages/Documents/Dynamic-Web-API\#minification)

ASP.NET Boilerplate dynamic api, as well as localization javascript can also
be returned minifed, by setting the _minify_\\* flag:
...
### Enable/Disable [Anchor](https://aspnetboilerplate.com/Pages/Documents/Dynamic-Web-API\#enable-disable)
...
### Wrapping Results [Anchor](https://aspnetboilerplate.com/Pages/Documents/Dynamic-Web-API\#wrapping-results)

ASP.NET Boilerplate **wraps** the return values of dynamic Web API actions
using an **AjaxResponse** object. See the [ajax\\
documentation](https://aspnetboilerplate.com/Pages/Documents/Javascript-API/AJAX) for more
...
handling](https://aspnetboilerplate.com/Pages/Documents/Handling-Exceptions) will be disabled (DontWrapResult
attribute has WrapOnError properties that can be used to enable the handling
and wrapping for exceptions).

#### WrapResultFilters [Anchor](https://aspnetboilerplate.com/Pages/Documents/Dynamic-Web-API\#wrapresultfilters)
...
### About Parameter Binding [Anchor](https://aspnetboilerplate.com/Pages/Documents/Dynamic-Web-API\#about-parameter-binding)

ASP.NET Boilerplate creates Api Controllers on runtime. ASP.NET Web
API's [model and parameter\\
binding](https://www.asp.net/web-api/overview/formats-and-model-binding/parameter-binding-in-aspnet-web-api)
is used to bind models and parameters. You can read the following
[documentation](https://www.asp.net/web-api/overview/formats-and-model-binding/parameter-binding-in-aspnet-web-api)
for more information.

#### FormUri and FormBody Attributes [Anchor](https://aspnetboilerplate.com/Pages/Documents/Dynamic-Web-API\#formuri-and-formbody-attributes)

**FromUri** and **FromBody** attributes can be used in the service interface
for advanced control binding.

#### DTOs vs Primitive Types [Anchor](https://aspnetboilerplate.com/Pages/Documents/Dynamic-Web-API\#dtos-vs-primitive-types)
