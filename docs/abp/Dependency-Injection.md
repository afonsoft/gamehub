...
[Edit on GitHub](https://github.com/aspnetboilerplate/aspnetboilerplate/blob/master/doc/WebSite/Dependency-Injection.md)

In this document

### What is Dependency Injection? [Anchor](https://aspnetboilerplate.com/Pages/Documents/Dependency-Injection\#what-is-dependency-injection-)

If you already know the Dependency Injection, Constructor and
Property Injection pattern concepts, you can skip to the [next\\
section](https://aspnetboilerplate.com/Pages/Documents/Dependency-Injection#asp-net-boilerplate-dependency-injection-infrastructure).

Wikipedia says: " _Dependency injection is a software design pattern in_
_which one or more dependencies (or services) are injected, or passed by_
_reference, into a dependent object (or client) and are made part of the_
_client's state. The pattern separates the creation of a client's_
_dependencies from its own behavior, which allows program designs to be_
_loosely coupled and to follow the dependency inversion and single_
_responsibility principles. It directly contrasts the service locator_
_pattern, which allows clients to know about the system they use to find_
_dependencies._".
...
#### Problems of the Traditional Way [Anchor](https://aspnetboilerplate.com/Pages/Documents/Dependency-Injection\#problems-of-the-traditional-way)

In an application, classes depend on each other. Assume that we have an
[application service](https://aspnetboilerplate.com/Pages/Documents/Application-Services) that uses a
[repository](https://aspnetboilerplate.com/Pages/Documents/Entities) to insert
[entities](https://aspnetboilerplate.com/Pages/Documents/Entities) into a database. In this situation,
...
#### Solution [Anchor](https://aspnetboilerplate.com/Pages/Documents/Dependency-Injection\#solution)

There are some best practices (patterns) to help us depend on other classes.

##### Constructor Injection Pattern [Anchor](https://aspnetboilerplate.com/Pages/Documents/Dependency-Injection\#constructor-injection-pattern)
...
Fortunately, there are [Dependency Injection frameworks](https://aspnetboilerplate.com/Pages/Documents/Dependency-Injection#dependency-injection-frameworks), which automate the management of dependencies.

##### Property Injection pattern [Anchor](https://aspnetboilerplate.com/Pages/Documents/Dependency-Injection\#property-injection-pattern)
...
##### Dependency Injection frameworks [Anchor](https://aspnetboilerplate.com/Pages/Documents/Dependency-Injection\#dependency-injection-frameworks)
...
### ASP.NET Boilerplate Dependency Injection Infrastructure [Anchor](https://aspnetboilerplate.com/Pages/Documents/Dependency-Injection\#asp-net-boilerplate-dependency-injection-infrastructure)
...
#### Registering Dependencies [Anchor](https://aspnetboilerplate.com/Pages/Documents/Dependency-Injection\#registering-dependencies)
...
##### Conventional Registrations [Anchor](https://aspnetboilerplate.com/Pages/Documents/Dependency-Injection\#conventional-registrations)

ASP.NET Boilerplate automatically registers all
[Repositories](https://aspnetboilerplate.com/Pages/Documents/Repositories), [Domain\\
Services](https://aspnetboilerplate.com/Pages/Documents/Domain-Services), [Application\\
Services](https://aspnetboilerplate.com/Pages/Documents/Application-Services), MVC Controllers and
...
system](https://aspnetboilerplate.com/Pages/Documents/Module-System) for more info.
...
##### Helper Interfaces [Anchor](https://aspnetboilerplate.com/Pages/Documents/Dependency-Injection\#helper-interfaces)
...
##### Custom/Direct Registration [Anchor](https://aspnetboilerplate.com/Pages/Documents/Dependency-Injection\#custom-direct-registration)
...
###### Using IocManager [Anchor](https://aspnetboilerplate.com/Pages/Documents/Dependency-Injection\#using-iocmanager)

You can use the **IocManager** to register dependencies (generally in the
PreInitialize method of your [module definition](https://aspnetboilerplate.com/Pages/Documents/Module-System) class):
...
#### Resolving Dependencies [Anchor](https://aspnetboilerplate.com/Pages/Documents/Dependency-Injection\#resolving-dependencies)
...
#### Constructor & Property Injection [Anchor](https://aspnetboilerplate.com/Pages/Documents/Dependency-Injection\#constructor-property-injection)
...
#### IIocResolver, IIocManager and IScopedIocResolver [Anchor](https://aspnetboilerplate.com/Pages/Documents/Dependency-Injection\#iiocresolver-iiocmanager-and-iscopediocresolver)
...
#### Extras [Anchor](https://aspnetboilerplate.com/Pages/Documents/Dependency-Injection\#extras)

##### IShouldInitialize interface [Anchor](https://aspnetboilerplate.com/Pages/Documents/Dependency-Injection\#ishouldinitialize-interface)
...
##### `Lazy<T>` components [Anchor](https://aspnetboilerplate.com/Pages/Documents/Dependency-Injection\#lazy-t-components)
...
#### ASP.NET MVC & ASP.NET Web API integration [Anchor](https://aspnetboilerplate.com/Pages/Documents/Dependency-Injection\#asp-net-mvc-asp-net-web-api-integration)
...
#### ASP.NET Core Integration [Anchor](https://aspnetboilerplate.com/Pages/Documents/Dependency-Injection\#asp-net-core-integration)
...
#### Final notes [Anchor](https://aspnetboilerplate.com/Pages/Documents/Dependency-Injection\#final-notes)
