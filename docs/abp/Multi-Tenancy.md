...
[Edit on GitHub](https://github.com/aspnetboilerplate/aspnetboilerplate/blob/master/doc/WebSite/Multi-Tenancy.md)

In this document

### What Is Multi-Tenancy? [Anchor](https://aspnetboilerplate.com/Pages/Documents/Multi-Tenancy\#what-is-multi-tenancy-)

" _Software_ **_Multitenancy_** _refers to a software_ **_architecture_** _in which a_ **_single instance_** _of a software runs on a server and_
_serves **_multiple tenants_**. A tenant is a group of users who share_
_a common access with specific privileges to the software instance. With_
_a multitenant architecture, a software application is designed to_
_provide every tenant a **_dedicated share of the instance including its_**_
_**_data_**, configuration, user management, tenant individual_
_functionality and non-functional properties. Multitenancy contrasts with_
_multi-instance architectures, where separate software instances operate_
_on behalf of different tenants_"
...
#### Database & Deployment Architectures [Anchor](https://aspnetboilerplate.com/Pages/Documents/Multi-Tenancy\#database-deployment-architectures)

There are some different multi-tenant database & deployment approaches:

##### Multiple Deployment - Multiple Database [Anchor](https://aspnetboilerplate.com/Pages/Documents/Multi-Tenancy\#multiple-deployment-multiple-database)
...
##### Single Deployment - Multiple Database [Anchor](https://aspnetboilerplate.com/Pages/Documents/Multi-Tenancy\#single-deployment-multiple-database)
...
##### Single Deployment - Single Database [Anchor](https://aspnetboilerplate.com/Pages/Documents/Multi-Tenancy\#single-deployment-single-database)
...
**filtering](https://aspnetboilerplate.com/Pages/Documents/Data-Filters)**.
...
##### Single Deployment - Hybrid Databases [Anchor](https://aspnetboilerplate.com/Pages/Documents/Multi-Tenancy\#single-deployment-hybrid-databases)
...
##### Multiple Deployment - Single/Multiple/Hybrid Database [Anchor](https://aspnetboilerplate.com/Pages/Documents/Multi-Tenancy\#multiple-deployment-single-multiple-hybrid-database)
...
### Multi-Tenancy in ASP.NET Boilerplate [Anchor](https://aspnetboilerplate.com/Pages/Documents/Multi-Tenancy\#multi-tenancy-in-asp-net-boilerplate)

ASP.NET Boilerplate can work with all the scenarios described above.

#### Enabling Multi-Tenancy [Anchor](https://aspnetboilerplate.com/Pages/Documents/Multi-Tenancy\#enabling-multi-tenancy)
...
#### Ignore Feature Check For Host Users [Anchor](https://aspnetboilerplate.com/Pages/Documents/Multi-Tenancy\#ignore-feature-check-for-host-users)
...
#### Host vs Tenant [Anchor](https://aspnetboilerplate.com/Pages/Documents/Multi-Tenancy\#host-vs-tenant)
...
#### Session [Anchor](https://aspnetboilerplate.com/Pages/Documents/Multi-Tenancy\#session)
...
[authorized](https://aspnetboilerplate.com/Pages/Documents/Authorization) content.
...
See the [session documentation](https://aspnetboilerplate.com/Pages/Documents/Abp-Session) for more
information.

#### Determining Current Tenant [Anchor](https://aspnetboilerplate.com/Pages/Documents/Multi-Tenancy\#determining-current-tenant)
...
name is _http://www.aspnetboilerplate.com/identity/claims/tenantId_
and should contain an integer value. If it's not found in claims
then the user is assumed to be a _host_ user.
2. If the user has not logged in, then it tries to resolve the TenantId from the
_tenant resolve contributor_ s. There are 3 pre-defined tenant
...
1. **DomainTenantResolveContributor**: Tries to resolve tenancy
      ...
      the current host of the request is **_acme_.mydomain.com**, then the
...
##### Tenant Store [Anchor](https://aspnetboilerplate.com/Pages/Documents/Multi-Tenancy\#tenant-store)
...
data source. [Module Zero](https://aspnetboilerplate.com/Pages/Documents/Zero/Overall) properly implements it by
getting it from its [tenant manager](https://aspnetboilerplate.com/Pages/Documents/Zero/Tenant-Management). So if you
are using Module Zero, you don't need to worry about the tenant store.

#### Data Filters [Anchor](https://aspnetboilerplate.com/Pages/Documents/Multi-Tenancy\#data-filters)
...
retrieving [entities](https://aspnetboilerplate.com/Pages/Documents/Entities) from the database. ASP.NET
...
##### IMustHaveTenant Interface [Anchor](https://aspnetboilerplate.com/Pages/Documents/Multi-Tenancy\#imusthavetenant-interface)
...
##### IMayHaveTenant interface [Anchor](https://aspnetboilerplate.com/Pages/Documents/Multi-Tenancy\#imayhavetenant-interface)
...
##### Additional Notes [Anchor](https://aspnetboilerplate.com/Pages/Documents/Multi-Tenancy\#additional-notes)
...
#### Switching Between Host and Tenants [Anchor](https://aspnetboilerplate.com/Pages/Documents/Multi-Tenancy\#switching-between-host-and-tenants)

While working on a multi-tenant application database, we can get the
**current tenant**. By default, it's obtained from the
[IAbpSession](https://aspnetboilerplate.com/Pages/Documents/Abp-Session) (as described before). We can change
...
[session](https://aspnetboilerplate.com/Pages/Documents/Abp-Session). There are some guidelines and
best practices here:
...
work](https://aspnetboilerplate.com/Pages/Documents/Unit-Of-Work), be sure that your code runs in a UOW.
